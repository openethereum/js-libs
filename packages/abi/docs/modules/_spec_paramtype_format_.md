...
*Defined in [spec/paramType/format.ts:72](https://github.com/paritytech/js-libs/blob/add7962/packages/abi/src/spec/paramType/format.ts#L72)*
...
*Defined in [spec/paramType/format.ts:15](https://github.com/paritytech/js-libs/blob/add7962/packages/abi/src/spec/paramType/format.ts#L15)*
