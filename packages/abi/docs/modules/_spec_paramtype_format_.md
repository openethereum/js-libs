...
*Defined in [spec/paramType/format.ts:72](https://github.com/paritytech/js-libs/blob/8df9422/packages/abi/src/spec/paramType/format.ts#L72)*
...
*Defined in [spec/paramType/format.ts:15](https://github.com/paritytech/js-libs/blob/8df9422/packages/abi/src/spec/paramType/format.ts#L15)*
