...
describe('util/encode', () => {
  ...
  describe('abiEncode', () => {
    it('encodes calls with the correct result', () => {
      expect(abiEncode('valid', ['uint256', 'bool'], [0x123, true])).toEqual(`0x${RESULT}`);
    });
  ...
  describe('abiSignature', () => {
    it('encodes baz(uint32,bool) correctly', () => {
      ...
      ).toEqual('0xcdcd77c0992ec5bbfc459984220f8c45084cc24d9b6efed1fae540db8de801d2');
    });
  });
});
